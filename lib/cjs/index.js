...
var TagSphere = function (props) {
    ...
    var _a = __assign(__assign({}, defaultState), props), maxSpeed = _a.maxSpeed, initialSpeed = _a.initialSpeed, tags = _a.tags, initialDirection = _a.initialDirection, keepRollingAfterMouseOut = _a.keepRollingAfterMouseOut, fullHeight = _a.fullHeight, fullWidth = _a.fullWidth, style = _a.style, userSelect = _a.userSelect, blur = _a.blur;
