...
export var TagSphere = function (props) {
    ...
    var _a = __assign(__assign({}, defaultState), props), maxSpeed = _a.maxSpeed, initialSpeed = _a.initialSpeed, texts = _a.texts, initialDirection = _a.initialDirection, keepRollingAfterMouseOut = _a.keepRollingAfterMouseOut, fullHeight = _a.fullHeight, fullWidth = _a.fullWidth, style = _a.style, userSelect = _a.userSelect, blur = _a.blur;
    var radius = props.radius || texts.length * 15;
    var depth = 2 * radius;
    var size = 1.5 * radius;
    var itemHooks = texts.map(function () { return createRef(); });
    ...
    var next = function () {
        setItems(function (items) {
            ...
            return items.map(function (item) {
                return updateItemPosition(item, sc, depth, userSelect, blur);
            });
        });
    };
    var init = function () {
